...
export default function IconSearch(props) {
  ...
  //   } else if (button === "secondary" || button === "ghost") {
  //     return theme.palette.interactive.primary.default;
  ...
  const chevronDown = (
    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-down" width={handleSizeChange(size)} height={handleSizeChange(size)} viewBox="0 0 24 24" strokeWidth="2" stroke={handleColorChange(button)} fill="none" strokeLinecap="butt" strokeLinejoin="butt">
  ...
  const remove = (
    <svg aria-labelledby="cds-5138-title" fill={handleColorChange(button)} focusable="false" height={handleSizeChange(size)} role="img" viewBox="0 0 24 24" width={handleSizeChange(size)} className="icon css-0" id="cds-5138"><title id="cds-5138-title">Large</title><path fillRule="evenodd" clipRule="evenodd" d="M21.646 22.354l-20-20 .708-.708 20 20-.707.708z" ></path><path fillRule="evenodd" clipRule="evenodd" d="M22.354 2.354l-20 20-.708-.708 20-20 .708.708z"></path></svg>
  )
